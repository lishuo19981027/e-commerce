...
import com.imooc.ecommerce.config.GatewayConfig;
...
public class GlobalLoginOrRegisterFilter implements GlobalFilter , Ordered {
    ...
    * */
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        //3.访问其他的服务，则鉴权，校验是否能够从Token中解析用户信息
    ...
    /*从授权中心获取Token*/
    private String getTokenFromAuthorityCenter(ServerHttpRequest request , String uniFormat){
        ...
        String requestUrl = String.format(
                uniFormat,serviceInstance.getHost(),serviceInstance.getPort()
        );
